        ...
        def savemoney() :
            ...
            if currency == "งบประมาณแผ่นดิน" :
                ...
                self.window3.destroy()
                 #สร้าง function inputmoney คล้ายinputdata
        ...
        try:
            if ID in self.SubjectID:
                ...
                def success():
                    ...
                    if confirm == "yes" :
                        self.x2_value = entry_2.get() if entry_2.get() else ''
                        ...
                        for j in range(len(self.ValueList)):
                            ...
                            #ติดปัญหาแถวเลื่อน ทำให้ไม่ตรงกัน
